...
\usepackage[left=1.25cm,top=1.5cm,right=1.25cm,bottom=1.5cm]{geometry}
...
\pagestyle{fancy}
\fancyhf{}
\fancyfoot[C]{\small Dr. Alexander C. Whitehead \textbar{} Publications and Research Outputs \textbar{} \thepage}
...
\begin{document}
    ...
    alexandercwhitehead@gmail.com

    \vspace{0.35cm}
    \begin{spacing}{1.6}
        \begin{rSection}{Selected Publications and Research Outputs}
            \vspace{-0.5cm}
            \item \begin{rSubsection}{Improved Quantification for Respiratory Gated PET/CT: Data-Driven Algorithms for Respiratory Motion Correction in PET/CT}{}{University College London}{2025}
                \vspace{-0.25cm}
                \item \textbf{Whitehead~A.C.} \\
                \vspace{-0.5cm}
                \item \textbf{Doctoral thesis} \\
                \\
            \end{rSubsection}
            
            \vspace{-0.5cm}
            \item \begin{rSubsection}{Advancing Generalisable Neural Network-Based PET Quantification: A Multicenter [$^{11}$C]PBR28 study}{}{IEEE EMBC}{2025}
                \vspace{-0.25cm}
            ...
            \vspace{-0.5cm}
            \item \begin{rSubsection}{Data Driven Surrogate Signal Extraction for Dynamic PET Using Selective PCA: An Ensemble Method}{}{Physics in Medicine \& Biology}{2024}
                \vspace{-0.25cm}
            ...
            \item \begin{rSubsection}{STIR Software for Tomographic Image Reconstruction}{}{Zenodo}{2024}
                \vspace{-0.25cm}
                \item Efthimiou~N. et al. (including \textbf{Whitehead~A.C.})
                \\
            \end{rSubsection}
    ...
    \begin{spacing}{1.2}
        \begin{rSection}{Complete Publications and Research Outputs}
            \vspace{-0.5cm}
            \item \begin{rSubsection}{Non-invasive full quantification of dynamic [$^{11}$C]PBR28 PET imaging with ASTRA}{}{ }{in preparation}
                \vspace{-0.25cm}
                \item Brusaferri~L.~\textbf{\textsuperscript{\S}}, \textbf{Whitehead~A.C.~\textsuperscript{\S}}, Barzon~L., Maccioni~L., Alshelh~Z., Minhae~K., Antonio~M., Toschi~N., Ferrante~M., Inglese~M., Catana~C., Gilman~J., Veronese~M., Howes~O., Marques~T.R., Nettis~M.A., Mondelli~V., Pariante~C., Turkheimer~F.E., Grisan~E., and Loggia~M.L. \\
                \vspace{-0.5cm}
                \item \textbf{\textsuperscript{\S}These authors contributed equally} \\
                \\
            \end{rSubsection}
            ...
            \vspace{-0.5cm}
            \item \begin{rSubsection}{Mortality Maps: Inherently Interpretable Event-Conditional Survival Analysis}{}{ }{in preparation}
                \vspace{-0.25cm}
                \item \textbf{Whitehead~A.C.}
                \\
            \end{rSubsection}
            ...
            \vspace{-0.5cm}
            \item \begin{rSubsection}{Pseudo-Bayesian DIP Denoising as a Preprocessing Step for Kinetic Modelling in Dynamic PET}{}{IEEE NSS MIC RTSD}{2022}
                \vspace{-0.25cm}
            ...
            \vspace{-0.5cm}
            \item \begin{rSubsection}{Impact of Time-of-Flight on Respiratory Motion Modelling using Non-Attenuation-Corrected PET}{}{IEEE NSS MIC RTSD}{2019}
                \vspace{-0.25cm}
